  ...
  return (
    <section className="relative w-full h-screen bg-corp-950 text-white overflow-hidden flex flex-col justify-center">
      ...
      <motion.div 
        ...
        className="absolute top-[20%] left-[-10%] w-[500px] h-[500px] bg-corp-800/20 rounded-full blur-[120px] pointer-events-none z-0"
      ></motion.div>
        ...
        <div className="flex flex-col lg:flex-row h-full items-center">
          ...
          <div className="w-full lg:w-1/2 flex flex-col justify-center pt-20 lg:pt-0 relative z-20">
            ...
            <motion.div 
              ...
              className="h-1 bg-accent-gold mb-8 shadow-[0_0_15px_rgba(197,179,136,0.3)]"
            ></motion.div>
            ...
            <motion.h1 
              ...
              className="text-5xl lg:text-7xl font-sans font-bold leading-tight tracking-tight mb-6 text-white drop-shadow-2xl"
            >
              Ramón Romero
            </motion.h1>
            ...
            <motion.p 
              ...
              className="text-xl lg:text-2xl text-corp-300 font-light mb-10 max-w-lg leading-relaxed"
            >
              CPA, Auditoría &<br/>
          ...
          <motion.div 
            ...
            className="w-full lg:w-1/2 h-full relative flex items-end justify-center lg:justify-end pointer-events-none"
          >
            <img 
